...
func addPath(r *gin.Engine) {
	...
	r.GET("/download_pdf", authMiddleWare(), checkPermission(), downloadPdf)                      //生成并获取PDF文档
	...
	r.GET("/get_processing_attorney", authMiddleWare(), checkPermission(), getProcessingAttorney) //寻找零件
