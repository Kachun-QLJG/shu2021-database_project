...
if __name__ == '__main__':
    ...
    generator = MultiPlateGenerator('license plate generator/plate_model', 'license plate generator/font_model')
    img = generator.generate_plate_special(args.plate_number, args.bg_color, args.double)
    cv2.imencode('.jpg', img)[1].tofile('./html/statics/license plates/'+args.plate_number + '.jpg')